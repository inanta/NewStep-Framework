...
class LDAP extends Object {
	...
	function bind($username, $password) {
		if(ldap_bind($this->_connection, $username, $password) === true) return true;
	...
	function __construct($host) {
		if(!function_exists('ldap_connect')) throw new LibraryException(array('code' => NS_EX_LIB_NOT_INSTALLED, 'class' => __CLASS__, 'library' => 'LDAP'));
		if(!$this->_connection = ldap_connect($host)) throw new NetException(array('code' => NetException::NOT_CONNECTED, 'server' => $host));
